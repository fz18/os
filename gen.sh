...
echo -e "\033[32m生成build/kernel/kernel.o \033[0m"
nasm -f elf -o build/kernel/kernel.o kernel/kernel.S
echo -e "\033[32m==================================================================================================== \033[0m"

echo -e "\033[32m生成build/kernel/main.o \033[0m"
gcc -m32 -I ./lib/ -I ./lib/kernel/ -I kernel/ -c -fno-builtin -o build/kernel/main.o kernel/main.c
...
ld -melf_i386 -Ttext 0xc0001500 -e main -o build/kernel/kernel.bin build/kernel/main.o build/kernel/print.o \
 build/init.o build/interrupt.o build/kernel/kernel.o build/timer.o && \
